...
public class Router {
    ...
    private static void configure() {
        ...
        Spark.get("/AdopcionPorDuenio/:id",adopcionController::mostrarAdoptarDuenio,Router.engine);
        Spark.post("/AdopcionPorDuenio/:id",adopcionController::guardarAdopcionPorDuenio);
